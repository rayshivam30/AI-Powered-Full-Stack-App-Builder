...
export function ProjectsDashboard() {
    ...
    useEffect(() => {
        ...
        if (queryParams.get("checkout") === "success") {
            ...
            if (userInfo) {
                localStorage.setItem("user_info", JSON.stringify({ ...userInfo, plan: "PRO" }));
            }
            toast({
                title: "🎉 Plan Upgraded Successfully!",
                description: "Welcome to Pro Builder! Your account now has unlimited AI access and priority speed.",
            });
